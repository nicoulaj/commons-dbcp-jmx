 ...
 * <p/>
 * Only tests the added value to {@link ManagedBasicDataSource}, i.e. the MBean part.
 *
...
public class ManagedBasicDataSourceTest extends AbstractMBeanTest {
    ...
    /**
     * Assert creating a new {@link ManagedBasicDataSource} registers a MBean.
     *
    ...
    /**
     * Assert creating a new {@link ManagedBasicDataSource} through the {@link ManagedBasicDataSourceFactory}
     * registers a MBean.
     *
     * @throws Exception should not happen.
     */
    ...
    public Object[][] testAttributeExistsProvider() {
        return new Object[][]{{"NumActive"}, {"NumIdle"}, {"MaxActive"}, {"MaxIdle"}, {"MinIdle"}, {"MaxWait"}};
    }
